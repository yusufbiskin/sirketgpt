...
Her faaliyet grubu için en az 5 alt madde olacak şekilde devam et. Maddeleri uzun cümleler kurarak resmi yazı dilinde ve kanunlara, mevzuata uygun şekilde yaz."""
    ...
    doc.add_paragraph(f"Sirketin merkezi {merkez_il.upper()} ili {merkez_ilce.upper()} ilçesidir.")
    ...
    doc.add_paragraph("Sirketin süresi, kurulusundan itibaren sınırsızdır. Bu süre sirket sözlesmesini degistirmek suretiyle uzatılıp kısaltılabilir.")
